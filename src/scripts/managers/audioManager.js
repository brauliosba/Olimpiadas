...
export class AudioManager
{
    ...
    load(){
        ...
        this.scene.load.audio(`mainTheme`, [ `./src/audios/m4a/maintheme.m4a`, `./src/audios/ogg/maintheme.ogg` ]);
        this.scene.load.audio(`gameplayTheme`, [ `./src/audios/m4a/gameplay.m4a`, `./src/audios/ogg/gameplay.ogg` ]);
        //sfx
